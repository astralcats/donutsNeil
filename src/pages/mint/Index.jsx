...
const contractAddress = "0x6EA84fAc4939F26aCE3e6De8fC0f1A7f08A91Af6";
const contractABI = [
  {
  ...
  {
    inputs: [{ internalType: "uint256", name: "numDeezDonuts", type: "uint256" }],
    name: "mintDeezDonuts",
    outputs: [],
    stateMutability: "payable",
    type: "function",
  },
  { inputs: [], name: "mintDozenDeezDonuts", outputs: [], stateMutability: "payable", type: "function" },
  {
    anonymous: false,
    inputs: [
...
const mintPrice1 = "50000000000000000";
const mintPrice12 = "450000000000000000";
  ...
  return (
    <div className="flex justify-start items-center flex-col w-full">
      ...
      <div className=" flex justify-between items-center w-full py-3 px-6 absolute top-0 left-0">
        <button
          onClick={() => window.open("http://www.deezdonutzmerch.com")}
          className="uppercase p-3 bg-[#f266b7] text-white text w-42 h-25 grid place-items-center rounded-full relative drop-shadow-lg"
        >
          GET YOUR DEEZ DONUTZ MERCH
        </button>
        {}
      ...
      <div className="flex flex-col w-[90%] max-w-[1200px] h-screen pt-[150px] min-h-[700px]  justify-start items-start">
        <div className="flex justify-around items-center w-full gap-20">
          <div className="flex justify-start items-center flex-col gap-3">
            <p className="text-[#fa7fc2] uppercase text-center leading-[1] text-lg 2xl:text-xl">
              Minted <br /> <span className="text-white">{minted}/</span>600
              <br /> <span className="text-secondary">Deezdonutz</span>
            </p>
          </div>
        </div>
        <div className="flex justify-start flex-col self-center items-center mt-8 md:mt-5 w-full max-w-[1000px]">
          <div className="flex justify-around items-center w-full gap-20">
            <div className="flex justify-start items-center flex-col gap-3">
              ...
              <button
                onClick={mint}
                className="bg-[#f266b7] text-white text-xl w-16 h-16 grid place-items-center rounded-full relative drop-shadow-lg"
              >
                <p className="absolute left-[45%] top-1/2 -translate-x-1/2 -translate-y-1/2">+1</p>
              </button>
              <p className="text-secondary uppercase text-center text-lg 2xl:text-xl">0.025 ETH</p>
            </div>
            <div className="flex justify-start items-center flex-col gap-3">
              <p className="text-[#fa7fc2] uppercase text-center leading-[1] text-lg 2xl:text-xl">
              ...
              <button
                ...
                className="bg-[#f266b7] text-white text-xl w-16 h-16 grid place-items-center rounded-full relative drop-shadow-lg"
              >
                <p className="absolute left-[45%] top-1/2 -translate-x-1/2 -translate-y-1/2">+12</p>
              </button>
              <p className="text-secondary uppercase text-center text-lg 2xl:text-xl">0.28 ETH</p>
            </div>
          </div>
          <img
        ...
        <div className="flex justify-center pb-4 items-center w-full mt-auto">
          <p className="text-secondary text-center sm:text-base text-xs">
            <br /> CONTACT: <br />
            <a href="mailto:NEILFRICKINDIAMONDHANDS@GMAIL.COM">NEILFRICKINDIAMONDHANDS@GMAIL.COM</a>
          </p>
        </div>
      </div>
    </div>
